...
def apply_filters_callback():
    ...
    for i, block in enumerate(filter_blocks):
        ...
        try:
            filtered_df = feat_engg_backend.apply_filter_block(source_df, block)
        ...
        for i, filter_block in enumerate(filter_blocks):
            ...
            with row1_cols[1]: # This is where your "Select Table" selectbox is
                ...
                if all_datasets_for_dropdown: # Only proceed if there are datasets available
                    ...
                    selected_dataset_option_value = filter_block.get("dataset", all_datasets_for_dropdown[0] if all_datasets_for_dropdown else "")
            ...
            with row1_cols[2]:
                ...
                current_feature = filter_block("feature")
            ...
            with row2_cols[0]:
                ...
                operation = st.selectbox("Select Filter Type", OPERATIONS,
                                         index=OPERATIONS.index(filter_block("operation", OPERATIONS[0])) if filter_block("operation") in OPERATIONS else 0,
                                         key=f"operation_{i}")
            ...
            with row2_cols[1]:
                ...
                current_value = filter_block("value")
