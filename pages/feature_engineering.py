...
st.markdown("""
    ...
    /* Increase the height of the multiselect box */
    [data-baseweb="select"] {
        min-height: 150px !important;  /* Increased from 60px to 150px */
        max-height: 300px !important;  /* Added max-height limit */
    }
    
    /* Style for the select container to show more content */
    [data-baseweb="select"] > div:first-child {
        min-height: 150px !important;  /* Match the container height */
        height: auto !important;
        align-items: flex-start !important;
        padding: 8px !important;
    }
    
    /* Improve scrolling for selected items */
    [data-baseweb="select"] > div:first-child > div:first-child {
        max-height: 280px !important;  /* Allow space for scrolling */
        overflow-y: auto !important;
    }
    
    /* Reduce font size for selected feature tags */
    [data-baseweb="tag"] {
    ...
    /* Reduce font size for dropdown options */
    [data-baseweb="select"] div[role="option"] {
        font-size: 11px !important;
    }
    
    /* Adjust dropdown container height */
...
st.markdown("""
    ...
    /* Keep dropdown menu open and increase its height */
    ...
    [data-testid="stVerticalBlock"] > div:has(h3:contains("Multiple Features Transformation")) [data-baseweb="popover"] > div {
        position: static !important;
        transform: none !important;
        width: 100% !important;
        max-height: 300px !important;
...
st.markdown("""
    ...
    /* Style selected items container */
    [data-testid="stVerticalBlock"] > div:has(h3:contains("Multiple Features Transformation")) [data-baseweb="select"] > div:first-child {
    ...
    /* Ensure the dropdown stays in place */
    [data-testid="stVerticalBlock"] > div:has(h3:contains("Multiple Features Transformation")) [role="listbox"] {
        position: static !important;
        visibility: visible !important;
        display: block !important;
    }
